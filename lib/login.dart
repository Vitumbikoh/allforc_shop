    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        if (userType != null) {
          ...
          print('User type not found for user ${userCredential.user!.uid}');
        }
                  ...
                  child: Stack(
                    ...
                    children: [
                      Image.asset(
                        ...
                        color: Color.fromARGB(255, 178, 231, 157)
                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                          ...
                          color: Color.fromARGB(255, 242, 248, 237),
                        ),
                        child: TextFormField(
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color.fromARGB(255, 121, 207, 86),
                        ),
                        child: const Text(
                          'Sign In',
                          style: TextStyle(
